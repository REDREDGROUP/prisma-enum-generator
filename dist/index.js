    ...
    onGenerate: function (options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        outputPath = (_a = options.generator.output) === null || _a === void 0 ? void 0 : _a.value;
                        dbProviders = options.datasources[0].provider;
                        dbUrl = options.datasources[0].url.value;
                        ...
                        _b = dbProviders;
                        switch (_b) {
                            case "postgresql": return [3 /*break*/, 1];
                        }
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, (0, database_1.getPostgresEnumTableValue)({
                            databaseUrl: dbUrl,
                    ...
                    case 2:
                        _c.sent();
                        return [3 /*break*/, 4];
                    case 3: throw new Error('This version only supports the postgres SQL database.');
